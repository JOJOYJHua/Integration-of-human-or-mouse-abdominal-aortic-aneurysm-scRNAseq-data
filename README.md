...
This repository provides a reproducible pipeline for integrating and analyzing single-cell RNA sequencing (scRNA-seq) data from human and mouse abdominal aortic aneurysm (AAA) tissues, as detailed in our manuscript. The workflow handles data preprocessing, batch correction with Harmony, clustering, differential expression (DEGs), cell type annotation, and cell-cell communication inference using Seurat and CellChat. Outputs include UMAP visualizations, heatmaps, and interaction networks that align with the paper's figures—enabling full reproducibility for researchers studying AAA pathogenesis, lymphangiogenesis, and tertiary lymphoid structures (TLS).
